...
import templates from './RestFilterLabel.soy';

/**
 * Metal RestFilterLabel component.
 * @extends ClayComponent
 */
class RestFilterLabel extends ClayComponent {
	/**
...
Soy.register(RestFilterLabel, templates);

export {RestFilterLabel};
export default RestFilterLabel;